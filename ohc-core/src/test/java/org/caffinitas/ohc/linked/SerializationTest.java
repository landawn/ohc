...
public class SerializationTest {
    ...
    public void testDirectIO() throws IOException {
        ...
        try (OHCache<Integer, String> cache = OHCacheBuilder.<Integer, String> newBuilder()
            ...
            try (BufferedWritableByteChannel ch = new BufferedWritableByteChannel(
                    FileChannel.open(f.toPath(), StandardOpenOption.WRITE, StandardOpenOption.TRUNCATE_EXISTING), 8192)) {
        ...
        try (OHCache<Integer, String> cache = OHCacheBuilder.<Integer, String> newBuilder()
            ...
            try (BufferedReadableByteChannel ch = new BufferedReadableByteChannel(
                    FileChannel.open(f.toPath(), StandardOpenOption.READ, StandardOpenOption.TRUNCATE_EXISTING), 8192)) {
    ...
    public void testDirectIOBig() throws IOException {
    ...
    @Test(dependsOnMethods = "testDirectIO")
    public void testDirectIOBigRandom() throws IOException {
    ...
    @Test(dependsOnMethods = "testDirectIO")
    public void testCompressedDirectIO() throws IOException {
    ...
    public void testCompressedDirectIOBig() throws IOException {
    ...
    @Test(dependsOnMethods = "testCompressedDirectIO")
    public void testCompressedDirectIOBigRandom() throws IOException {
    ...
    @Test
    public void testTooBigEntryOnDeserialize() throws IOException {
